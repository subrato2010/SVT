...
import com.edifixio.soc.dao.GradeMasterDAO;
...
import com.edifixio.soc.dao.ParameterDAO;
...
public class DAOProviderImpl implements DAOProvider {
    ...
    private TwitLogDAO<TwitLog> twitLogDAO;
    private GradeMasterDAO<GradeMaster> gradeMasterDAO;
    ...
    public TwitLogDAO<TwitLog> getTwitLogDAO() {
        return twitLogDAO;
    }
    public void setTwitLogDAO(TwitLogDAO<TwitLog> twitLogDAO) {
        this.twitLogDAO = twitLogDAO;
    }
    public GradeMasterDAO<GradeMaster> getGradeMasterDAO() {
        return gradeMasterDAO;
    }
    public void setGradeMasterDAO(GradeMasterDAO<GradeMaster> gradeMasterDAO) {
        this.gradeMasterDAO = gradeMasterDAO;
    }
    public ParameterDAO<Parameter> getParameterDAO() {
        return parameterDAO;
    }
    public void setParameterDAO(ParameterDAO<Parameter> parameterDAO) {
