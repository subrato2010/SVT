...
public class SpringObjectFactory {
	...
	public final static String SPRING_CONFIG_FILE = "spring-daos.xml";
	...
	private SpringObjectFactory() {
		setSpringContext(new ClassPathXmlApplicationContext(springPaths,com.edifixio.soc.persist.util.SpringObjectFactory.getInstance().getSpringContext()));
	}
