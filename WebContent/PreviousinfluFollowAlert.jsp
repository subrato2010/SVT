  		...
  		<tr height="35">
  			...
  			<div class="fileinputs1">
    	                      ...
    	                      <div class="alertDropDown" >
        	                     <input id="vkinflalertlist" type="text" value="@#{twitterController.firstCustomerName}" 
...
<tr>
    	...
    	<table width="100%" cellpadding="0" cellspacing="0">
    		<tr>
    			...
    			<a href="#" onclick="parent.document.getElementById('GRButton').click(); parent.document.getElementById('floatingDiv1').style.display='none';">
				    <img src="../images/Alert/General/followButtonOrange.gif" border="0"
				    onmouseover="changeImage(this,'../images/Alert/General/followButtonOrangeRollover.gif');" 
  ...
  <tr>
  	<td align="right" valign="top"  colspan="3">
  		<a onclick="parent.document.getElementById('floatingDiv').style.display='none'; parent.document.getElementById('backDrop').style.display='none'; parent.document.getElementById('transParentDiv').style.display='none';" href="#" class="closeOrangeTextAlert" style="color: #F2A413; text-decoration: none;">
  		CLOSE
  		</a>
  	</td>
  </tr>
