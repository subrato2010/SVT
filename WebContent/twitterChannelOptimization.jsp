<ui:composition xmlns="http://www.w3.org/1999/xhtml"
    ...
    <f:view>
   			<h:form id="twitterChannelOptimizer" enctype="multipart/form-data">
   			   <div class="page">
     	<table width="100%" border="0" cellpadding="0" cellspacing="0">
 <!--********************************** Total Top three Section Start **************************************-->
            <tr>
                                 ...
                                 <tr>
                                     	<td align="left" valign="top">
												...
												<table width="397" border="0" cellspacing="0" cellpadding="0"
													style="margin-left: 15px;" height="80">
													<tr>
														<td valign="bottom" align="center" width="208">
															<h:commandLink value=""	actionListener="#{channelPerformanceController.channelPerformanceTabClick}" 
																style="text-decoration: none;">
																<img src="../images/channelPerformanceGeneral.gif" border="0"  
                          			 								onmouseover="this.src='../images/channelPerformanceGeneral.gif'"
                              		 								onmouseout="this.src='../images/channelPerformanceGeneral.gif'"/>
			                								</h:commandLink>
														</td>
														<td width="10"></td>
														<td valign="bottom" align="center" width="177"> <img
															src="../images/channelOptimizationSelected.gif" border="0"/> 
														</td>
                                                               ...
                                                               <table width="240" border="0" cellspacing="0" cellpadding="0">
                                                                     <tr>
                                                                       ...
                                                                       <table cellpadding="0" cellspacing="0">
                                                                       	<tr>
                                                                       		<td valign="middle" align="left"  class="topFirstTablehd">
                                                                       		Goal
                                                                       		</td>
                                                                       		<td valign="middle" align="left">
                                                                       		<h:graphicImage value="../images/bulb.jpg" 
																			     ...
																			     <rich:toolTip styleClass="tooltip" showEvent="onmouseover" direction="bottom-right" mode="client" layout="block">
																			         <span><h:outputText value="This is the target you've chosen to achieve in your goal of improving your performance relative to your competitors.  
                                                                    ...
                                                                    <tr>
                                                                       ...
                                                                       <td valign="middle" align="left" class="topFirstTableMatter" width="15">
																		<h:graphicImage value="../images/bulb.jpg" 
																		      onmouseover="this.src='../images/bulb_green.jpg';" onmouseout="this.src='../images/bulb.jpg';">
																		     <rich:toolTip styleClass="tooltip" showEvent="onmouseover" direction="bottom-right" mode="client" layout="block">
																		         <span><h:outputText value="This is the target you've chosen to achieve in your goal of improving your performance relative to your competitors. Moderate - reduce the gap between you and your competitors.
																		Aggressive - close the gap between you and your competitors. Very Aggressive - outperform your competitors." /></span>
																		     </rich:toolTip>
																		</h:graphicImage>                   
                                                                       </td>
                                                                           	...
                                                                           	<tr>
                                                                           		...
                                                                           		<td valign="middle" align="left">
	                                                                           		<h:graphicImage value="../images/bulb.jpg" 
																					      onmouseover="this.src='../images/bulb_green.jpg';" onmouseout="this.src='../images/bulb.jpg';">
																					     <rich:toolTip styleClass="tooltip" showEvent="onmouseover" direction="bottom-right" mode="client" layout="block">
																					         <span><h:outputText value="Profile Actions are outbound activities that will help you to reach your goal." /></span>
																					     </rich:toolTip>
																					</h:graphicImage> 
                                                                           		</td>
                                                                           	</tr>
...
<!-- This block will be removed after clarification from Wendy -->
                                                                     ...
                                                                     <tr>
                                                                       <td valign="middle" align="left" class="topFirstTableinflu" width="95">
																		...
																		<h:graphicImage value="../images/grayLogo.gif" 
																		      onmouseover="this.src='../images/grayLogo.gif';" onmouseout="this.src='../images/grayLogo.gif';" style="margin-left: 4px;">
																		     <rich:toolTip styleClass="tooltip" showEvent="onmouseover" direction="bottom-right" mode="client" layout="block">
																		         <span><h:outputText value="Flames represent actual performance degradation in this metric." /></span>
																		     </rich:toolTip>
																		</h:graphicImage> 
																		...
																		<h:graphicImage value="../images/grayLogo.gif" 
                                                                           ...
                                                                           <!--<img src="../images/orangeLogo.gif" border="0"/>
                                                                           <img src="../images/grayLogo.gif" border="0"/>
                                                                           <img src="../images/grayLogo.gif" border="0"/>
                                                                           <img src="../images/grayLogo.gif" border="0"/>
                                                                       --></td>
                                                                       <td valign="middle" align="left" class="topFirstTableinflu" width="205">
                                                                       25 influencers to follow
                                                                       </td>
                                                                       <td valign="middle" align="left" class="topFirstTableinflu" width="70">
                                                                     ...
                                                                     <tr>
                                                                       <td valign="middle" align="left" class="topFirstTableMatter">
                                                                           <table width="350" border="0" cellspacing="0" cellpadding="0">
                                                                                 <tr>
                                                                                   <td valign="middle" align="left">
                                                                        <h:graphicImage value="../images/milestoneImage7.gif" 
																		      onmouseover="this.src='../images/milestoneImage7.gif';" onmouseout="this.src='../images/milestoneImage7.gif';" style="margin-left: 4px;">
																		     <rich:toolTip styleClass="tooltip" showEvent="onmouseover" direction="bottom-right" mode="client" layout="block">
																		         <span><h:outputText value="You have been Optimizing for 1 month and under." /></span>
                                                                                   ...
                                                                                   <td valign="middle" align="left">
                                                                        <h:graphicImage value="../images/milestoneImage1.gif" 
																		      onmouseover="this.src='../images/milestoneImage1.gif';" onmouseout="this.src='../images/milestoneImage1.gif';" style="margin-left: 4px;">
																		     <rich:toolTip styleClass="tooltip" showEvent="onmouseover" direction="bottom-right" mode="client" layout="block">
																		         <span><h:outputText value="You have reached your Very Aggressive (gold), Aggressive (silver) or Moderate (bronze) goal." /></span>
                                                                                   ...
                                                                                   <td valign="middle" align="left">
                                                                       <h:graphicImage value="../images/milestoneImage2.gif" 
																		      onmouseover="this.src='../images/milestoneImage2.gif';" onmouseout="this.src='../images/milestoneImage2.gif';" style="margin-left: 4px;">
																		     <rich:toolTip styleClass="tooltip" showEvent="onmouseover" direction="bottom-right" mode="client" layout="block">
																		         <span><h:outputText value="Awarded each time you increase your Influence score." /></span>
                                                                                   ...
                                                                                   <td valign="middle" align="left">
                                                                        <h:graphicImage value="../images/milestoneImage3.gif" 
																		      onmouseover="this.src='../images/milestoneImage3.gif';" onmouseout="this.src='../images/milestoneImage3.gif';" style="margin-left: 4px;">
																		     <rich:toolTip styleClass="tooltip" showEvent="onmouseover" direction="bottom-right" mode="client" layout="block">
																		         <span><h:outputText value="Awarded each time you increase your #hashtag usage by at least 5%." /></span>
                                                                                   ...
                                                                                   <td valign="middle" align="left">
                                                                          <h:graphicImage value="../images/milestoneImage4.gif" 
																		      onmouseover="this.src='../images/milestoneImage4.gif';" onmouseout="this.src='../images/milestoneImage4.gif';" style="margin-left: 4px;">
																		     <rich:toolTip styleClass="tooltip" showEvent="onmouseover" direction="bottom-right" mode="client" layout="block">
																		         <span><h:outputText value="Awarded each time you increase your Bit.ly usage by at least 10%." /></span>
                                                                                   ...
                                                                                   <td valign="middle" align="left">
                                                                         <h:graphicImage value="../images/milestoneImage5.gif" 
																		      onmouseover="this.src='../images/milestoneImage5.gif';" onmouseout="this.src='../images/milestoneImage5.gif';" style="margin-left: 4px;">
																		     <rich:toolTip styleClass="tooltip" showEvent="onmouseover" direction="bottom-right" mode="client" layout="block">
																		         <span><h:outputText value="Awarded each time you increase your Positive sentiment by at least 5% or decrease you Negative sentiment by at least 3%." /></span>
                                                                                   ...
                                                                                   <td valign="middle" align="left">
                                                                         <h:graphicImage value="../images/milestoneImage6.gif" 
																		      onmouseover="this.src='../images/milestoneImage6.gif';" onmouseout="this.src='../images/milestoneImage6.gif';" style="margin-left: 4px;">
																		     <rich:toolTip styleClass="tooltip" showEvent="onmouseover" direction="bottom-right" mode="client" layout="block">
            			...
            			<table width="1050" border="0" cellspacing="0" cellpadding="0" style="border-bottom:1px solid #D4D4D4;border-top:1px solid #D4D4D4; margin-bottom:10px; margin-top:10px;">
            				<tr>
                				<td width="1" align="left" valign="middle">
                 					...
                 					<img src="../images/grayDropDown.gif" border="0" /></a>
                				</td>
...
<!-- Populating values for outbound --> 
							...
							<a4j:repeat value="#{channelPerformanceController.outboundMetricsDummy}" var="overallOutbounds" rowKeyVar="i"> 
<!-- 
								  a4j:outputPanel rendered="#{(overallOutbounds.custVolume lt overallOutbounds.custTarget)}"
-->
...
-->								  
            ...
            <tr>
             ...
             <table width="100%" border="0" cellspacing="0" cellpadding="0">
                   <tr>
                     <td valign="middle">
                         <div class="mainBodyBottomUpper1">
                         <a id="displayTextRTO" href="javascript:toggleRTO();">
                         <img src="../images/dropDown.gif" border="0"/>
                         </a>
                         </div>
                         <div class="mainBodyBottomUpper2">
                         <table width="100%" border="0" cellspacing="0" cellpadding="0" height="100%">
                                       <tr>
                                         <td valign="middle" align="left" class="mainBodyBottomUpperLeftText">Real-Time Optimization</td>
                                       </tr>
                         </table>
                         </div>
                         <div class="mainBodyBottomUpper3">
                             <table width="100%" border="0"  cellpadding="0" cellspacing="0">
                         <tr>
                         <td valign="middle" align="center">
...
<div class="listDivTop" id="list_x1" onmouseover="setInList(true);" onmouseout="setInList(false);">
	 <ui:repeat value="#{channelPerformanceController.twitterAccount}" var="twitterAccount">
		...
		<div class="listBottomDiv"></div>
                         ...
                         <div class="mainBodyBottomUpper4">
                         <table height="27" cellpadding="0" cellspacing="0">
                         <tr>
                         <td valign="middle" align="center" class="mainBodyBottomUpperLeftText" width="80" style="padding-bottom: 7px;">Sort By:</td>
                         <td valign="top" align="center">                        
                         ...
                         <div class="mainBodyBottomUpper5">
                         
                         <h:commandButton value=""  type="submit" id="refreshTwitt" image="../images/refreshButton.gif" 
									actionListener="#{twitterController.twittMessage}" 
									style="text-decoration: none;" onclick="location.href='twitterChannelOptimization.jsp?refresh=0'">
                              	<a4j:support event="onsubmit" immediate="true"/>
                          	</h:commandButton>
                         </div>
                     </td>
                   </tr>
                   ...
                   <tr align="right">
                   <td width="1000" align="right" valign="middle" colspan="5">
                				<table border="0" cellspacing="0" cellpadding="0" class="topFirstTablehdCategory">
	                          			<tr>
	                            			<td valign="middle" align="left">
	                            			Geolocation
							...
							<tr>
								<td id="#{twitterList.dtoLeft.cnt}" width="525" valign="top" align="left" 
									...
									<ui:include src="/realTimeOptimizationData.jsp">
										...
										<ui:param name="textareacontent" value="Theme"/>
								...
								<td id="#{twitterList.dtoRight.cnt}" width="525" valign="top" align="right" 
									...
									<ui:include src="/realTimeOptimizationData1.jsp">
