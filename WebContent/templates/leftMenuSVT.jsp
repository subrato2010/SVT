		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
			<tr>
				...
				<table width="100%" height="26" border="0" id="table_#{x}"
					class="#{((channel.channelName eq menu.currentMenu.title)||(channel.channelName eq menu.currentMenu.currentChannelDTO.channelName))? 'openheader' : 'menuheader'} " 
					cellpadding="0" cellspacing="0" onmouseover="rollover('#{x}')" onmouseout="rollover('#{x}')">
					<tr>
				...
				<ul class="categoryitems">
					...
					<ui:repeat value="#{menu.categories}" var="category" rendered="#{menu.categories != null and channel.channelName == menu.currentMenu.currentChannelDTO.channelName}">
						<li><h:commandLink action="#{menu.select}" value="#{category.categoryNameEscaped}" 
