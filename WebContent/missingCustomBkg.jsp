<ui:composition xmlns="http://www.w3.org/1999/xhtml"
	...
	<script>
		//<![CDATA[
	            ...
	            function updateProgress(i)
	             {
	                $('missingProfileBkgImg:progressBar').component.setValue(counter*5);
	                if ((counter++)>20)
		            {
	            ...
	            {
	                counter = 1;
	                $('missingProfileBkgImg:progressBar').component.enable();
	                $('missingProfileBkgImg:progressBar').component.setValue(1);
	            ...
	            function checkContent(str)
	            {
	            	if(str.length > 0)
		            {
	            		...
	            		{
	            			document.getElementById('missingProfileBkgImg:bkgUpdateButton').style.display = "block";
	...
	<h:form id="missingProfileBkgImg" enctype="multipart/form-data">
					...
					<td align="left" valign="middle" width="260">
						<div class="fileinputs1" style="width: 30px; color: #7D848B;">							             				
             				<twt:menu id="inflalertlist" value="#{popupController.firstTwitterAccount}" 
             					paramName="selectedProfileForBkg"             					
								options="#{popupController.accountsMissingBkg}" 
			...
			<table width="380" cellpadding="0" cellspacing="0" border="0">
				<tr height="30">
					<td valign="middle" colspan="2" align="left"
						class="missingBackground">ADD YOUR BACKGROUND</td>
				</tr>
				<tr>
					...
					<table width="280" border="0" cellpadding="0" cellspacing="0"
						...
						<tr>
							...
							<t:inputFileUpload 
									value="#{popupController.userProfileBackgroundImage}" styleClass="file"
									storage="file"
						...
						<tr>
							...
							<a4j:outputPanel rendered="#{(popupController.backgroundUpdate)}">
								<div class="missingUpload" id="fileSelectDiv" 
										style="padding-left: 5px; color: #77C442;">Background image updated</div>
							</a4j:outputPanel>
	
							<div class="missingUpload" id="fileSelectDiv" style="padding-left: 5px;"></div>
							<td valign="top" align="left" class="missingMatter">Images	must be smaller than 800k. GIF,JPG,PNG.</td>
							</tr>
					</table>
					</td>
				</tr>
					...
					<table width="380" cellpadding="0" cellspacing="0" border="0">
						<tr>
							<td valign="bottom" align="left">
								...
								<h:commandLink id="bkgUpdateButton" actionListener="#{popupController.uploadUserProfileBackgroundImage}" style="display: none;">
									<img src="../images/Alert/updateButtonOrange.gif" border="0" 
											style="margin-right: 5px; cursor: pointer;" 
											onclick="startProgress();clickLink('missingProfileBkgImg:refreshImage')"/>
								</h:commandLink>
