...
<ui:composition xmlns="http://www.w3.org/1999/xhtml"
	...
	<ui:define name="menu">	
		<ui:include src="/templates/leftMenuSVT.jsp">
			<ui:param name="menu" value="#{loyaltyController}"/>
		</ui:include>
	</ui:define>	

		<ui:define name="tabs">
		<ui:include src="/inc/siTabs.jsp">
				<ui:param name="currentTab" value="#{loyaltyController.currentSentimentName}"/>
		</ui:include>
	</ui:define>
	
	<ui:define name="body_right_pannel">
		<ui:include src="/inc/siContent.jsp">
			<ui:param name="commonController" value="#{loyaltyController}"/>
		</ui:include>
	</ui:define>
</ui:composition>
