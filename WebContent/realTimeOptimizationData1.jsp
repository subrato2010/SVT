<ui:composition xmlns="http://www.w3.org/1999/xhtml"
	...
	>
	 <f:view>
   			<h:form id="realTimeOptimizationData1">
	<table width="505" border="0" cellspacing="0" cellpadding="0"  style="padding-top: 6px; border-bottom:1px solid #F5F5F5;">
		<tr>
            ...
            <td valign="top" align="center" width="60">
            	<a4j:outputPanel rendered="#{!(msgtype eq 'NEGATIVE')}">  
            		<img src="../images/retweet.gif" border="0" style="padding-bottom:2px;"/>
                </a4j:outputPanel>
                         ...
                         <td width="120" valign="bottom">
							<table width="100%" border="0" cellspacing="0" cellpadding="0" height="55">
								...
								<tr><td valign="bottom" align="left" style="font-size: 24px; padding-top: 30px;">
									<h:commandButton image="../images/sendTweetButton.gif" id="b#{tdid}"
													 onclick="document.getElementById('#{tdid}').innerHTML='Tweet Success!';"
													 style="cursor: pointer;" 
													 actionListener="#{twitterController.sendIndividualTwitt}">
								  	</h:commandButton>
								</td></tr>
                            </table>
						 </td>
