...
<title>Login | Optimizer for Twitter</title>
				...
				<form action="j_security_check" name="login" id="login" method="post">
					<table width="90%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							<td valign="top" align="left" colspan="2"><img
								src="../images/twitterLOGOMain.gif" border="0" />
							</td>
						</tr>
						<tr>
							<td valign="top" align="left" colspan="2"><img
								src="../images/signin.png" border="0" />
							</td>
						</tr>
						<tr>
							<td valign="top" align="left" width="270">
								<table width="100%" border="0" cellpadding="0" cellspacing="0" style="margin-top: 20px;">
									<input type="hidden" id="logstatus" value="<%= request.getParameter("status") %>"  />
									<script language="javascript">
										if(document.getElementById("logstatus").value == "logout1"){
											document.getElementById("logstatus").value="";
											if(location == null){
												location.href="../faces/twt.jsp?status=logout";
											}else{
												parent.location.href="../faces/twt.jsp?status=logout";
											}									
										}
									</script>
									<%
									if(request.getParameter("status")==null) {
									  ...
									  loginCredentials="";
									  //request.set
									  response.sendRedirect("../faces/blank.jsp?status=logout1");
									}
								...
								<table width="96%" border="0" cellpadding="0" cellspacing="0"
									...
									<tr>
										<td valign="top" align="left">
											<div style="float: left; display: inline; margin-right: 6px; margin-left: 0px; margin-top: 0px;">
												<img src="../images/warning.PNG" />
											</div>
											<div style="font-size: 9px; float: left; display: inline;" class="topChannelPerformanceDateLogin">
												<font style="font-weight: normal;color: <%=color%>;"><%=loginCredentials%></font>
											</div>
										</td>
									</tr>
											<%
											     ...
											     request.getSession().setAttribute("f","");
											%>
									<table width="96%" border="0" cellpadding="0" cellspacing="0" style="border: 1px solid #F90011;">
										<tr>
											<td valign="top" align="left">
												<div style="float: left; display: inline; margin-right: 6px; margin-left: 0px; margin-top: 0px;">
													<img src="../images/warning.PNG" />
							...
							<td valign="middle" align="left" style="padding-left: 20px;">
					     	...
					     	<img src="../images/logoutRight.gif" width="389" height="107"
												alt="logout" usemap="#logout" border="0" /> 
								<map name="logout">
					...
					<tr>
						<td valign="bottom" align="left" height="30" colspan="2"><a
							...
							onclick="openPopupLogin('Forgot Password', 324, 90, 777, 343, 10, false, true, false, '../forgotPassword.html')">forgot
						my password</a>
						</td>
					</tr>
					<tr>
	...
	<tr>
		<td align="left" valign="top">
			<div class="footer">
							...
							<div class="footer_left">
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									...
									<tr>
										...
										is a product of</font> <font class="matter1">Terametric.com</font>
										<font class="matter"> | </font> <font class="matter1">
										<a href="#" class="forgot_password"
											onclick="openPopupLogin('Privacy & Security',324, 90, 777, 343, 10, false, true, false, '../security.html')"
											style="color: #AECE6F; text-decoration: none; font-size: 12px;">
										Privacy & Security </a> </font></td>
									</tr>
									<tr>
										<td valign="top" align="left" class="matter">&copy; 2011
										Great Minds Interactive, Inc. | Build ph 1.000.000.0</td>
									</tr>
								</table>
								</div>
								</td>
				...
				<div id="floatingDivLogin" class="glass" style="display: none;">
				<div id="innerMainDivLogin" class="innerMainLogin">

				<div class="headerLogin" id="popupHeaderLogin">
				<div class="menuItem demo active" title="containerIframe"></div>
				<div class="titleLogin" id="titleLogin"></div>
				<div class="closeLogin"><a href="#" onclick="closePopupLogin()"> <img
					id="popupCloseButtonLogin" src="../images/close.gif"
				...
				<iframe id="frameLogin" width="10%" height="10%" frameborder="0"
