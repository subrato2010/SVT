...
<div id="instanceDiv" class="countDetailsDivNew">
	...
	<table width="505" border="0" cellspacing="0" cellpadding="0">
		<tr>
			<td valign="top" align="left">  
				 <table width="505" border="0" cellspacing="0" cellpadding="0" id="msg#{tdid}" style="display: none;"
				 	height="217">
				 	<tr style="border-color: white">
				 		<td align="center" valign="middle"  height="217"> 
	...
	<table width="505" border="0" cellspacing="0" cellpadding="0"  style="padding-top: 6px; border-bottom:1px solid #F5F5F5;" id="realTime#{tdid}">
		<tr>
   			<td colspan="3" align="left" valign="top">
			   <div style="width: 505px; height: auto; padding-top: 6px;">
			   			...
			   			<tr>
							   ...
							   <a4j:outputPanel rendered="#{msgtype eq 'NEGATIVE'}">
								...
								<div style="float: left;">
									...
									<div id="twitterLogotextAreaTooltip_#{tdid}" class="twitterLogotextAreaTooltipLeft">
								   ...
								   <div style="float: right;"> 
									   ...
									   <a4j:outputPanel rendered="#{msgtype eq 'NEGATIVE'}">
										...
										<a4j:outputPanel rendered="#{!(msgtype eq 'NEGATIVE')}">
								   		...
								   		<div id="twitterOptActions_#{tdid}" class="twitterOptActionsLeft" onmouseover="cancelCloseTime();" 
	                                         ...
	                                         <div id="mouseoverTwitterActions">	  
	                                         	...
	                                         	<h:outputLink value="#" onclick="this.href='mailto:?subject=Check out this tweet from @#{twtScreenName}&amp;body=#{twtScreenName}: '+encodeURIComponent(document.getElementById('fullTweet_#{tdid}').value)+'%0A%0A Original Tweet:  http://twitter.com/#{twtScreenName}/statuses/#{twitterStatusID} %0A%0A%0A Sent via Optimizer for Twitter (www.terametric.com)';">
	                                         		<img id="emailTweetImg#{tdid}" src="../images/actionsEmaiGeneral.png" border="0" 
	                                         			style="cursor: pointer;" 	                                         			 
	                                         	...
	                                         	<a4j:commandLink actionListener="#{popupController.tweetToFavorite}" 
	                                         		oncomplete="document.getElementById('valueHidden#{tdid}').value='Yipee! Tweet successfully favorited.'; document.getElementById('xHidden#{tdid}').value='125';">	                                         		
        ...
        <tr>
            ...
            <td colspan="2">
               ...
               <div id="inputDiv_#{tdid-1}" style="display: none;">
	               <h:form>
		               <input type="hidden" id="twtTxtSelectedL_#{tdid-1}" name="twtTxtSelected_#{tdid-1}" value=""/>
		                	...
		                	<tr>
								<td width="50" valign="top" align="left">
		                         ...
		                         <td valign="top" align="center">
		                          ...
		                          <input type="hidden" name="sideClicked" value="Left"/>
		                          <input type="hidden" name="individualTweet" id="individualTweet_#{tdid-1}" value="#{referenceName}"/>
		                          	  <!--<textarea name="individualTweet" id="individualTweet_#{tdid-1}" 
		                         	 		   ...
		                         	 		   color: #B6D976; padding-left: 3px; padding-top: 3px; font-size: 12px; resize: none;" onkeydown="countLimitChars('#{tdid-1}');" onkeyup="setData('#{tdid-1}')">#{referenceName}
		                         	  </textarea -->		                         	  
		                         	  ...
		                         	  <div id="referenceName_#{tdid-1}" contenteditable="true" class="tweet-area" 
		                         	  	...
		                         	  	onmouseup="getMousePositionOnSelectionOnMouseUp(event); displayCountdetailsRTODivOn('#{tdid-1}', 'L', '../images/#{textarealogo}');" 
		                         	  	onblur="displayCountdetailsRTODivOff('#{tdid-1}', 'L');" onmousedown="getMousePositionOnSelectionOnMouseDown(event);">#{referenceName}</div>
								 </td>
										...
										<tr>
											 <td valign="bottom" align="left" style="font-size: 24px; padding-top: 30px;">
												<div id="sendTweetEnabled_#{tdid-1}">
													<a4j:commandLink id="leftTWT" style="cursor: pointer;" action="#{twitterController.sendTweetBasedOnRule}"
														oncomplete="javascript: showSuccessWindow('#{tdid-1}','#{twitterController.actionTaken}'); document.getElementById('transParentDocDiv').style.display='none';"
														onclick="change()">
														<f:param name="index" value="#{tdid-1}"/>
														<f:param name="sideClk" value="Left"/>
	...
	<div id="countdetailsRTOL#{tdid-1}" class="countDetailsDivRTO">
    	<div id="countDetailsLoaderRTOL#{tdid-1}" class="countDetailsLoader">
			<img id="preloaderRTOL#{tdid-1}" src="../images/preloader3.gif" class="preloaderRTO" alt="preloader"/>
		</div>
		<div id="countdetailsRTOLImgDiv#{tdid-1}" class="countdetailsRTOImgDiv">
			<img id="countdetailsRTOLImg#{tdid-1}" style="display: none;"/>
		</div>
    	<div id="countDetailsTextRTOL#{tdid-1}" class="countDetailsTextDivRTO"></div>
  	</div>
</f:view>
</ui:composition>